/*jslint browser: true, bitwise: false, nomen: false, plusplus: false, indent: 4, maxerr: 50 */
/**
 * evercookie -- extremely persistent cookies
 *
 * @version 0.4 (10/13/2010)
 * @author Samy Kamkar <code@samy.pl> http://samy.pl
 *
 * @requires swfobject-2.2.min.js
 *
 * @description
            ...
            this.evercookie_indexdb_storage = function(name, value) {
                try {
                    ...
                    if (window.indexedDB) {
                        ...
                        var request = window.indexedDB.open("idb_evercookie", ver);
